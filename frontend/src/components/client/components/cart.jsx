              ...
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  ...
                  <a
                    ...
                    onClick={() => {
                      deleteItem(item.id);notifyDelete();
                  }}
                  >
                    Eliminar
                  </a>
          ...
          <div id="summary" className="w-1/4 px-8 py-10">
            ...
            <div className="border-t mt-8">
              ...
              <button className="bg-amber-600 font-semibold hover:bg-amber-900 transition-colors py-3 text-sm text-white uppercase w-full" onClick={() => {
                      updateItem(getIdClient(productListStatus));notifyPedido();
                  }}>
                Realizar pedido
              </button>
            </div>
        ...
        <div className="flex shadow-md my-10">
          ...
          <div id="summary" className="w-1/4 px-8 py-10">
            ...
            <div className="border-t mt-8">
              ...
              <button className="bg-green-600 font-semibold hover:bg-green-900 transition-colors py-3 text-sm text-white uppercase w-full" onClick={() => {
                      updateItem(getIdClient(productList));notifyPedido();
                  }}>
                Realizar pago
              </button>
            </div>
